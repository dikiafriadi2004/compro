                    ...
                    <div class="hover-dropdown navshop-drop">
                        ...
                        <ul data-simplebar>
                            <li><a href="#!">
                                    <div class="media">
                                        <div class="img-wrap"><img class="img-fluid"
                                                src="backend/assets/images/ecom-dashboard/small-pro/1.jpg"
                                                alt=""></div>
                                        <div class="media-body">
                            ...
                            <li><a href="#!">
                                    <div class="media">
                                        <div class="img-wrap"><img class="img-fluid"
                                                src="backend/assets/images/ecom-dashboard/small-pro/2.jpg"
                                                alt=""></div>
                                        <div class="media-body">
                            ...
                            <li><a href="#!">
                                    <div class="media">
                                        <div class="img-wrap"><img class="img-fluid"
                                                src="backend/assets/images/ecom-dashboard/small-pro/3.jpg"
                                                alt=""></div>
                                        <div class="media-body">
                            ...
                            <li><a href="#!">
                                    <div class="media">
                                        <div class="img-wrap"><img class="img-fluid"
                                                src="backend/assets/images/ecom-dashboard/small-pro/4.jpg"
                                                alt=""></div>
                                        <div class="media-body">
                            ...
                            <li><a href="#!">
                                    <div class="media">
                                        <div class="img-wrap"><img class="img-fluid"
                                                src="backend/assets/images/ecom-dashboard/small-pro/5.jpg"
                                                alt=""></div>
                                        <div class="media-body">
                                            <h6>iphone</h6><span class="text-light">$140</span>
                                        </div>
                ...
                <li class="nav-profile">
                    <div class="media">
                        <div class="user-icon"><img class="img-fluid rounded-50"
                                src="backend/assets/images/avtar/3.jpg" alt="logo"></div>
                        <div class="media-body">
