...
$( document ).ready(function() {
  ...
  $('.sidebar-action').click(function () {
    // Get the current value of the 'data-sidebar-type' attribute
    var currentSidebarType = $('body').attr('data-sidebar-type');

    // Toggle between 'compact' and 'default'
    if (currentSidebarType === 'compact') {
